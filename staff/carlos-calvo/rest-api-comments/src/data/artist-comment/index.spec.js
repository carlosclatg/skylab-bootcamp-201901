...
describe('artist comments data', () => {
    beforeEach(() => fsp.writeFile(path.join(__dirname, 'artist-comments.json'), JSON.stringify([])))
    ...
    after(() => fsp.writeFile(path.join(__dirname, 'artist-comments.json'), JSON.stringify([])))
})